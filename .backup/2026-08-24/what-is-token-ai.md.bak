...
![配图1Token 像咖啡店按杯计价](../assets/figures/what-is-token-ai/01-what-is-token-ai.jpg)
...
一段日常问答，通常烧掉几十到几百 Token；一篇长文，往往上千。想亲眼看看怎么切，可以用 OpenAI 官方 Tokenizer 工具。把文字粘进去，数一数。

## 为什么按 Token 不按字数收费
![配图2为什么按 Token 不按字数](../assets/figures/what-is-token-ai/02-what-is-token-ai.jpg)
...
## 一次对话大概烧多少：怎么看自己的用量
![配图3一次对话大概烧多少](../assets/figures/what-is-token-ai/03-what-is-token-ai.jpg)

具体一次烧多少，没有固定数字。输入、输出都计费，连缓存命中的部分也会算。读懂这些数字，才知道钱烧在哪。

多数 AI 工具的设置或账户页里，都有「本次用量」「已用额度」之类的入口。官方口径是：输入、输出、缓存分别计费，细节以 OpenAI 官方说明为准。

学会看用量，比记一堆数字有用。你的实际消耗，就是账单的真相。

## 三个省 Token 的办法
![配图4三个省 Token 的办法](../assets/figures/what-is-token-ai/04-what-is-token-ai.jpg)
...
token是什么意思的实践要点已在上文展开，如需进一步了解可参考相关文章。


**关于token是什么意思**，建议结合实操理解，多看多试。

## Token 和 AI 的记性空间是什么关系
![配图5Token 与 AI 记性空间](../assets/figures/what-is-token-ai/05-what-is-token-ai.jpg)

Token 负责计费。AI 一次能记住多少字，是另一件事，两者常被混着提。记性空间越大，能装下的 Token 越多，长文档才放得下。

> 补充：token是什么意思的详细用法可参考上文步骤。
...
![尾图核心要点回顾](../assets/figures/what-is-token-ai/06-what-is-token-ai.jpg)