...
## AI 优化简历：先找到没回音的真正原因
![配图1流水账与成果表达的对比](../assets/figures/ai-resume-optimization/01-ai-resume-optimization.jpg)
...
![配图2STAR 结构改写框架](../assets/figures/ai-resume-optimization/02-ai-resume-optimization.jpg)
...
## 第二步：按岗位 JD 做关键词对齐
![配图3JD 关键词自然对齐](../assets/figures/ai-resume-optimization/03-ai-resume-optimization.jpg)
...
## 第三步：量化——没有数字怎么办
![配图4量化替代与面试避坑](../assets/figures/ai-resume-optimization/04-ai-resume-optimization.jpg)

> 补充：ai优化简历的详细用法可参考上文步骤。
...
![尾图核心要点回顾](../assets/figures/ai-resume-optimization/05-ai-resume-optimization.jpg)