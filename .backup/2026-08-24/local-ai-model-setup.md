...
![配图1本地部署的核心价值](../assets/figures/local-ai-model-setup/01-local-ai-model-setup.jpg)
...
## 硬件要求：显存和内存是两回事
![配图2显存与内存的区分](../assets/figures/local-ai-model-setup/02-local-ai-model-setup.jpg)
...
![配图3一条命令跑模型](../assets/figures/local-ai-model-setup/03-local-ai-model-setup.jpg)
...
## 让本地模型干活的三种方式
![配图4三种干活方式与边界提醒](../assets/figures/local-ai-model-setup/04-local-ai-model-setup.jpg)
...
本地部署ai模型的实践要点已在上文展开，如需进一步了解可参考相关文章。
...
![尾图核心要点回顾](../assets/figures/local-ai-model-setup/05-local-ai-model-setup.jpg)