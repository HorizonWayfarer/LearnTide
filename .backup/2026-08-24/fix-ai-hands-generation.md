...
## AI 画手指崩坏怎么解决？先试第一层
![配图1负面提示词过滤](../assets/figures/fix-ai-hands-generation/01-fix-ai-hands-generation.jpg)
...
## 第一层：加负面提示词——最简单但最有效
![配图2切换基础模型](../assets/figures/fix-ai-hands-generation/02-fix-ai-hands-generation.jpg)
...
## 第二层：换模型——有些模型天生手画得好
![配图3局部重绘遮罩](../assets/figures/fix-ai-hands-generation/03-fix-ai-hands-generation.jpg)
...
![配图4专业插件与取舍](../assets/figures/fix-ai-hands-generation/04-fix-ai-hands-generation.jpg)
...
![尾图四层修复路径回顾](../assets/figures/fix-ai-hands-generation/05-fix-ai-hands-generation.jpg)