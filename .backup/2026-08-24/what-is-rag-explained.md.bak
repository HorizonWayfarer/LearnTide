...
## RAG 是什么：一句话解释
![配图1开卷考试：先查再答](../assets/figures/what-is-rag-explained/01-what-is-rag-explained.jpg)
...
## 为什么需要 RAG——AI 不擅长的事
![配图2RAG 三步走：检索·增强·生成](../assets/figures/what-is-rag-explained/02-what-is-rag-explained.jpg)
...
## RAG 怎么工作：三步走
![配图3RAG vs 微调：换资料 vs 改模型](../assets/figures/what-is-rag-explained/03-what-is-rag-explained.jpg)
...
## RAG 和微调的区别
![配图4何时不用 RAG：简单问答·创意写作](../assets/figures/what-is-rag-explained/04-what-is-rag-explained.jpg)
...
![尾图核心要点回顾](../assets/figures/what-is-rag-explained/05-what-is-rag-explained.jpg)